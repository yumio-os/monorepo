...
module "sg_db_postgres" {
  ...
  ports_to_source               = { 5432 = "${module.yumio_graphql_fargate_service.security_id},${module.ds_graphql_fargate_service.security_id},${module.bastion_host.security_group_id}" }
  ports_to_ip                   = {}
}
