...
module "alb" {
  ...
  vpc_id                = module.vpc.vpc_id
  # TODO - Replace with correct certificate
  # certificate_arn    = "arn:aws:acm:es-west-2:597532874516:certificate/f1195908-4c2c-45e1-b3ed-8d4278f9483b"
  certificate_arn    = [
    "arn:aws:acm:es-west-2:597532874516:certificate/a5fcb253-3e1c-4059-892e-485160bfd1e4"
  ]
